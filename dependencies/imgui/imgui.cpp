...
void ImGui::RenderText( ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash ) {
	...
	if ( text != text_display_end ) {
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 0, 1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 0, -1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( -1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 0, 1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 0, -1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end );
...
void ImGui::RenderTextWrapped( ImVec2 pos, const char* text, const char* text_end, float wrap_width ) {
	...
	if ( text != text_end ) {
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 0, 1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 0, -1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( 1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos - ImVec2( -1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 0, 1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 0, -1 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
		window->DrawList->AddText( g.Font, g.FontSize, pos + ImVec2( 1, 0 ), /*GetColorU32( ImGuiCol_Text )*/ GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_end, wrap_width );
...
void ImGui::RenderTextClippedEx( ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_display_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect ) {
	...
	if ( need_clipping ) {
		...
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 0.f, 1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 0.f, -1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( -1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 0.f, 1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 0.f, -1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, &fine_clip_rect );
		...
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 0.f, 1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 0.f, -1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( 1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos + ImVec2( -1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 0.f, 1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 0.f, -1.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
		draw_list->AddText( NULL, 0.0f, pos - ImVec2( 1.f, 0.f ), GetColorU32( ImVec4( 0.f, 0.f, 0.f, 1.f ) ), text, text_display_end, 0.0f, NULL );
...
bool ImGui::BeginChildEx( const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags ) {
	...
	char title [ 256 ];
	if ( name )
		ImFormatString( title, IM_ARRAYSIZE( title ), "%s##%08X", name, id );
	else
...
static void ImGui::RenderWindowOuterBorders( ImGuiWindow* window ) {
	...
	if ( border_size > 0.0f && !( window->Flags & ImGuiWindowFlags_NoBackground ) ) {
		...
		if ( window->Flags & ImGuiWindowFlags_ChildWindow ) {
			window->DrawList->AddLine( window->Pos + ImVec2( 10.f, 0.f ), window->Pos + ImVec2( window->Size.x - 10.f, 0.f ), GetColorU32( GetStyleColorVec4( ImGuiCol_ChildBg ) ) );
			RenderText( window->Pos + ImVec2( 15.f, -7.f ), window->Name );
		}
	}
